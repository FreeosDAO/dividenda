...
const std::string VERSION = "Version = 137 alpha"; 

//"Ver 137, 17th May, 2021; alpha";
...
const std::string freeos_acct       = "freeos1";
const name tokencontra              = "freeos1"_n;          ///< Token contract (for inline transfers)   
